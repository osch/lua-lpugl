...
PUGL_API_PRIVATE PuglWorldInternals*
...
PUGL_API_PRIVATE PuglInternals*
...
PUGL_API_PRIVATE bool
puglRectsInit(PuglRects* rects, int capacity);

PUGL_API_PRIVATE bool
puglRectsAppend(PuglRects* rects, PuglRect* rect);

PUGL_API_PRIVATE void
puglRectsFree(PuglRects* rects);
